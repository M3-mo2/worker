<?php
ob_start();
$API_KEY = "0000";// توكن بوتك العزيز
$buy = "@nnnnnnnnnr";//  يوزرك تليكرام .
$sudo = "6480697494";// خلي ايديك هنا .
$admin = "$sudo";// عوفة لا تبعبص بي .
$idBot = "6742069590";// ايدي بوتك خلي بشكل صحيح .
...
⌔︙[اضغط هنا الصنع بوت مجاني حمايه](t.me/Tbiix)
...
'inline_keyboard'=>[
[
['text'=>"$dataadd",'url'=>"https://t.me/Tbiix"]
],
]
])
]);
...
⌔︙[ اضغط هنا لديك مفاجئه ](https://t.me/Tbiix)",'parse_mode'=>"MARKDOWN",'disable_web_page_preview'=>true,'reply_to_message_id'=>$message->message_id, ]);}
...
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[['text'=>'‹ اضغط هنا لشراء بوت حماية .','url'=>"t.me/Tbiix"]],
[['text'=>'‹ تابع قناة تحديثات السورس .','url'=>"t.me/Tbiix"]],
[['text'=>'‹ تابع تيم السورس وكل تحديث .','url'=>"t.me/Tbiix"]],
...
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>'⌔︙تابع قناة السورس','url'=>'https://t.me/Tbiix']],]])]);}}}
