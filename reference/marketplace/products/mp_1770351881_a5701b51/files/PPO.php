<?php
ob_start();
$API_KEY = "00";// توكن بوتك العزيز
$buy = "@BBK_E";//  يوزر المطور .
$sudo = "7788601403";// حط ايديك هنا .
$admin = "$sudo";// لا تبعبص به .
$idBot = "8590172320";// ايدي البوت خلي بشكل صحيح .
$admmm = $sudo;// لا تبعصة .
$Dev = array("$sudo", "" );
$userrr = "BLA_0BOT"; # خلي معرف بوتك بدون ( @ )
...
$Dev = array("$admmm","7788601403"); # حط ايدي المطور ثاني المساعد او حط ايديك .
$channel = "bbl_y";
$token = API_KEY;
...
⌔︙[اضغط هنا الصنع بوت مجاني حمايه](t.me/bbl_y)
...
'inline_keyboard'=>[
[
['text'=>"$dataadd",'url'=>"https://t.me/bbl_y"]
],
]
])
]);
...
⌔︙[ اضغط هنا لديك مفاجئه ](https://t.me/bbl_y)",'parse_mode'=>"MARKDOWN",'disable_web_page_preview'=>true,'reply_to_message_id'=>$message->message_id, ]);}
...
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[['text'=>'‹ اضغط هنا لشراء بوت حماية .','url'=>"t.me/bbl_y"]],
[['text'=>'‹ تابع قناة تحديثات السورس .','url'=>"t.me/bbl_y"]],
[['text'=>'‹ تابع تيم السورس وكل تحديث .','url'=>"t.me/bbl_y"]],
[['text'=>'‹ مبرمج السورس ›','url'=>"t.me/bbk_e"]],
]
])
]); 
} 
...
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>'⌔︙تابع قناة السورس','url'=>'https://t.me/bbl_y']],]])]);}}}
...
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[['text'=>'‹ اضغط هنا لشراء بوت حماية .','url'=>"t.me/b_o81"]],
]
])
]); 
}}}}}
